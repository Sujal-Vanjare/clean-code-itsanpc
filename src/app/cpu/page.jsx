      ...
      <main className={styles.page}>
        <div className={styles.container}>
          ...
          <div className={styles.content}>
                ...
                <p className={styles.itemImgList}>
                  <span>
                    ...
                    <p>
                      ...
                      Refresh Rate, Panel Technology, Color Accuracy, Curved or
                      Flat Screen, Adaptive Sync Technologies like: NVIDIA
                ...
                <p className={styles.itemImgList}>
                  <span>
                    ...
                    <p>
                      ...
                      needs like, Mechanical Keyboard, Standard Keyboard, Laptop
              ...
              <li>
                <p className={styles.itemImgList}>
                  <span>
                    ...
                    <p>
                      There are several types of headphones available, Over-Ear
                      Headphones, On-Ear Headphones, Noise-Canceling Headphones,
                      Wireless Headphones, Gaming Headsets.
                    </p>
                  </span>
                  ...
                  <span>
                    <span>
                      ...
                      <p>
                        ...
                        while others require a separate dedicated graphics card.
                      </p>
                    </span>
                  </span>
                  <Image
                ...
                <p className={styles.itemImgList}>
                  <span>
                    <span>
                      ...
                      <p>
                        some cpu's come with their own stock cpu cooler, but some not so you nee to buy a separate cpu cooler
                        <br /> There are two most prominent CPU manufacturers
                        are Intel and AMD. Some CPUs have integrated graphics,
                        while others require a separate dedicated graphics card.
                      </p>
                ...
                <p className={styles.itemImgList}>
                  <span>
                    ...
                    <p>
                      ...
                      not then CPU integrated gpu is enough <br /> There are two
                      main GPU chip producers that are NVIDIA and AMD. <br /> in
                      GPU there is Founder's Edition Cards and Normal Card like
                      Asus, Msi, Gigabyte Card
                    </p>
                  </span>
                ...
                <p className={styles.itemImgList}>
                  <span>
                    ...
                    <p>
                      ...
                      SATA SSD, External SSD <br /> There are several reputable
                      SSD brands like Samsung, Crucial, Western Digital,
                      Kingston, etc.
                    </p>
                  </span>
                ...
                <p className={styles.itemImgList}>
                  <span>
                    ...
                    <p>
                      ...
                      performance <br /> There are several reputable brands that
                      manufacture high-quality RAM like Corsair, G.Skill,
                ...
                <p className={styles.itemImgList}>
                  <span>
                    ...
                    <p>
                      ...
                      Motherboard, so all the components will be communicate and
                      interact <br />
                      Motherboards come in various types and form factors such
                      as ATX, Micro-ATX, and Mini-ITX.
                      <br /> There are several motherboard brands in the market,
                      like ASUS, MSI, Gigabyte, ASRock, EVGA
                    </p>
                  </span>
              ...
              <li>
                <p className={styles.itemImgList}>
                  <span>
                    <strong>PSU</strong>
                    <p>
                      Now for all the component we need the power and that will
                      provide by Power Supply Unit
                      <br />
                      Here are some well-known PSU brands Corsair, EVGA, Cooler
                      Master, Be Quiet!, SilverStone ,etc
                    </p>
                  </span>
                ...
                <p className={styles.itemImgList}>
                  <span>
                    ...
                    <p>
                      ...
                      It will provide physical protection, cooling, and a place
                      to organize and assemble the various parts of a computer
                      system. <br />
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  For tasks like video editing, graphic design, or 3D rendering,
                  you'll need a powerful CPU, plenty of RAM, and possibly a
                  high-end graphics card(GPU).
                </p>
              </li>
              <li>
                <p>
                  ...
                  sufficient and you don't need additional graphic card(GPU) cpu
                  integrated graphics will be enough
                </p>
              </li>
              <li>
                <p>
            ...
            <p>
              It's crucial to establish a budget. Building a custom PC allows you to control costs better than buying a pre-built one, but it's still essential to have a spending limit in mind. Consider the following while setting your budget:
            </p>
            <ul>
              <li>
                <p>
                  All PC Components are important in their own way, if you buy a high-end CPU, and buy low-end Motherboard, like you spend most of your budget on the one component and compromise on others, this is very bad, It will affect the performance of your pc.
                </p>
              </li>
              <li>
                <p>
